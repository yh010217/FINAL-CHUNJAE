        ...
        fetch('/convertImage', {
            ...
            dataList.map(item => {
                ...
                if (index === 0) {
                    ...
                    const title_txt = document.createTextNode(saveName+"_문제");
                    ...
                    if (document.querySelectorAll(`.left${num}`) !== null) {
                        leftCount =
                            document.querySelectorAll(`.left${num}`).length;
                        if (leftCount > 0) {
                            left
                                = document.querySelectorAll(`.left${num}`)[leftCount - 1];
                    ...
                    if (document.querySelectorAll(`.right${num}`) !== null) {
                        rightCount =
                            document.querySelectorAll(`.right${num}`).length;
                        if (rightCount > 0) {
                            right
                                = document.querySelectorAll(`.right${num}`)[rightCount - 1];
